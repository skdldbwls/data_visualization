var data = [264896, 126401, 229573, 344095, 411637, 421086, 401562, 336852]

var svg = d3.select(".THEFT_time")
  .append("svg")
  .attr("width", 1200)
  .attr("height", 400)
...
data.forEach((d, i) => {
          ...
          var line = svg.append("line")
              .attr("x1", i * 90)
              .attr("y1", 300 - (data[i]/1500))
              .attr("x2", (i + 1) * 90)
              .attr("y2", 300 - (data[i+1]/1500))
